...
public class CoolParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("cool");
  ...
  { 
    CoolParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CoolParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CoolParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CoolParseControllerGenerated.class);
    }
  ...
  { 
    return CoolParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
