[
   ...
   Dim                                     -- KW["["] KW["]"],
   MethodAdditions                         -- _1 KW[":"] _2 _3 _4,
   MethodAdditions.2:opt                   -- _1,
   MethodAdditions.3:opt                   -- _1,
   MethodAdditions.4:opt                   -- _1,
   Requires                                -- KW["requires"] _1 KW[";"],
   OnEntry                                 -- KW["on_entry"] _1,
   OnExit                                  -- KW["on_exit"] _1,
   ...
   True                                    -- KW["true"],
   False                                   -- KW["false"],
   ConditionDec                            -- KW["condition"] _1 KW[";"],
   ConditionDec.1:iter-star-sep            -- _1 KW[","],
   Mutex                                   -- KW["mutex"] KW["{"] _1 KW["}"] KW[";"],
   Mutex.1:iter-star-sep                   -- _1 KW[","],
   TypeArgs                                -- KW["<"] _1 KW[">"],
   ...
   Float                                   -- KW["float"],
   Double                                  -- KW["double"],
   MethodSignature                         -- _1 KW["("] _2 KW[")"],
   MethodSignature.2:iter-star-sep         -- _1 KW[","],
   Selfex                                  -- KW["selfex"] KW["{"] _1 KW["}"] KW[";"],
   Selfex.1:iter-star-sep                  -- _1 KW[","],
   CoordinatorDec                          -- _1 _2,
   CoordinatorDecHead                      -- KW["coordinator"] _1,
   CoordinatorBody                         -- V  [V vs=2 [KW["{"] _1] KW["}"]],
   CoordinatorBody.1:iter-star             -- _1
]