...
public class CjpParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("cjp");
  ...
  { 
    CjpParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CjpParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CjpParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CjpParseControllerGenerated.class);
    }
  ...
  { 
    return CjpParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
