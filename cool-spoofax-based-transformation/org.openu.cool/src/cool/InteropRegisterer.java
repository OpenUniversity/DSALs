...
{ 
  ...
  { 
    ...
    varScope.addSVar("pp_aspectj_box_0_0", new InteropSDefT(pp_aspectj_box_0_0.instance, context));
    ...
    varScope.addSVar("fetch__class__name_0_0", new InteropSDefT(fetch__class__name_0_0.instance, context));
    ...
    varScope.addSVar("make_while_statement_0_2", new InteropSDefT(make_while_statement_0_2.instance, context));
  ...
  { 
    ...
    varScope.addSVar("pp_aspectj_box_0_0", new InteropSDefT(classLoader, "cool.pp_aspectj_box_0_0", context));
    ...
    varScope.addSVar("fetch__class__name_0_0", new InteropSDefT(classLoader, "cool.fetch__class__name_0_0", context));
    ...
    varScope.addSVar("make_while_statement_0_2", new InteropSDefT(classLoader, "cool.make_while_statement_0_2", context));
