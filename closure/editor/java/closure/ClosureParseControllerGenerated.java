...
public class ClosureParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Closure");
  ...
  { 
    ClosureParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = ClosureParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = ClosureParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(ClosureParseControllerGenerated.class);
    }
  ...
  { 
    return ClosureParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
