[
   ...
   JoinpointDeclaration                     -- KW["joinpoint"] _1 _2 KW["("] _3 KW[")"] _4 KW[";"],
   JoinpointDeclaration.3:iter-star-sep     -- _1 KW[","],
   JoinpointDeclaration.4:opt               -- _1,
   CJPAdvice                                -- _1 _2 _3 _4,
   CJPAdvice.1:iter-star                    -- _1,
   CJPAdvice.1:iter-star.1:alt              -- _1 _2,
   CJPAdvice.3:opt                          -- _1,
   CJPBefore                                -- KW["before"] _1 KW["("] _2 KW[")"],
   CJPBefore.2:iter-star-sep                -- _1 KW[","],
   CJPAfter                                 -- KW["after"] _1 KW["("] _2 KW[")"],
   CJPAfter.2:iter-star-sep                 -- _1 KW[","],
   CJPAfterReturning                        -- KW["after"] _1 KW["("] _2 KW[")"] KW["returning"] _3,
   CJPAfterReturning.2:iter-star-sep        -- _1 KW[","],
   CJPAfterReturning.3:opt                  -- _1,
   CJPAfterThrowing                         -- KW["after"] _1 KW["("] _2 KW[")"] KW["throwing"] _3,
   CJPAfterThrowing.2:iter-star-sep         -- _1 KW[","],
   CJPAfterThrowing.3:opt                   -- _1,
   CJPSingleParam                           -- KW["("] _1 KW[")"],
   CJPSingleParam.1:opt                     -- _1,
   CJPAround                                -- _1 KW["around"] _2 KW["("] _3 KW[")"],
   CJPAround.3:iter-star-sep                -- _1 KW[","],
   ClosureJoinpoints                        -- KW["exhibit"] _1 KW["("] _2 KW[")"] _3 KW["("] _4 KW[")"],
   ClosureJoinpoints.2:iter-star-sep        -- _1 KW[","],
   ClosureJoinpoints.4:iter-star-sep        -- _1 KW[","],
   ShortClosureJoinpoints                   -- KW["exhibit"] _1 _2
]