...
public class EjpParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("ejp");
  ...
  { 
    EjpParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EjpParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EjpParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EjpParseControllerGenerated.class);
    }
  ...
  { 
    return EjpParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
